...
<template>
  <section class="relative flex min-h-svh items-center justify-center px-6">
    <HeroScene />
    <div class="relative z-10 max-w-3xl text-center">
      <p class="font-mono text-sm tracking-widest text-primary-400 uppercase">
        {{ t('hero.eyebrow') }}
      </p>
      <h1 class="mt-4 text-5xl font-bold tracking-tight sm:text-7xl">
        {{ t('hero.name') }}
      </h1>
  ...
  <section id="about" class="relative py-24">
    <FloatingShape geometry="icosahedron" color="#77d8ee" :position="[3.8, 1, -2]" :size="1.3" :speed="1.2" />
    <div class="relative z-10 mx-auto max-w-3xl px-6">
      ...
      <p class="mt-6 text-lg leading-relaxed text-fog/80">
        {{ t('about.body') }}
      </p>
    </div>
  </section>
  ...
  <section id="skills" class="relative py-24">
    <FloatingShape geometry="octahedron" color="#c8ff4d" :position="[-4, -0.5, -2]" :size="0.9" :speed="0.8" />
    <div class="relative z-10 mx-auto max-w-3xl px-6">
      <p class="font-mono text-sm tracking-widest text-primary-400 uppercase">
        // {{ t('skills.eyebrow') }}
      </p>
      ...
      <div class="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div
          ...
          :key="skill"
          class="border border-line px-4 py-3 font-mono text-sm text-fog transition-colors hover:border-neon-300 hover:text-neon-300"
        >
          {{ skill }}
        </div>
      </div>
  ...
  <section id="timeline" class="relative py-24">
    <FloatingShape geometry="torusKnot" color="#169bba" :position="[4, -1.5, -2]" :size="1" :speed="0.9" />
    <div class="relative z-10 mx-auto max-w-3xl px-6">
      <p class="font-mono text-sm tracking-widest text-primary-400 uppercase">
        // {{ t('timeline.eyebrow') }}
      </p>
  ...
  <section id="work" class="relative py-24">
    <FloatingShape geometry="icosahedron" color="#35bddb" :position="[-4, 1, -2]" :size="1.1" :speed="1.1" />
    <div class="relative z-10 mx-auto max-w-3xl px-6">
      <p class="font-mono text-sm tracking-widest text-primary-400 uppercase">
        // {{ t('projects.eyebrow') }}
      </p>
  ...
  <section id="contact" class="relative py-24">
    <FloatingShape geometry="octahedron" color="#77d8ee" :position="[4, 1, -3]" :size="0.8" :speed="1.3" />
    <div class="relative z-10 mx-auto max-w-3xl px-6">
      <p class="font-mono text-sm tracking-widest text-primary-400 uppercase">
        // {{ t('contact.eyebrow') }}
      </p>
