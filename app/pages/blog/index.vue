...
<template>
  <section class="mx-auto max-w-3xl px-6 py-24">
    <p class="font-mono text-sm tracking-widest text-primary-400 uppercase">// {{ t('blog.eyebrow') }}</p>
    <h1 class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">{{ t('blog.heading') }}</h1>
